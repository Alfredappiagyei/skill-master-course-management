  ...
  render() {
    ...
    return (
      <div style={{ width: "100%", height: "100vh" }}>
        <div className='col-md-12' style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "10px" }}>
          <form onSubmit={this.handleSubmit} style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "10px" }}>
        ...
        <div className='col-md-6' style={{ display: "flex", flexWrap: "wrap", alignItems: "center", textAlign: "center", gap: 10 }}>
          <button className="button" style={{ width: "200px" }} onClick={this.handleSubmit}>Add New Employee</button>
          <button className="button" style={{ width: "200px" }} onClick={this.toggleModal}>View Employees</button>
          <button className="button" style={{ width: "200px" }}>Update Employee</button>
        </div>
