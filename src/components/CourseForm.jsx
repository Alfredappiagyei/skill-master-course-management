       ...
       <div style={{ width: "100%", height:"100vh" }}>
         <div className='col-md-6'>
           <form onSubmit={this.handleSubmit}>
             ...
             <input type="date" className="form-control" name="startDate" placeholder="Start Date" style={{ width: "300px" }} /><br />
             <input type="time" className="form-control" name="startTime" placeholder="Start Time" style={{ width: "300px" }} /><br />
             <input type="date" className="form-control" name="endDate" placeholder="End Date" style={{ width: "300px" }} /><br />
             <input type="time" className="form-control" name="endTime" placeholder="End Time" style={{ width: "300px" }} /><br />
             <input type="text" className="form-control" name="maxDelegates" placeholder="Maximun Delegates" style={{ width: "300px" }} /><br />
             <input type="text" className="form-control" name="confirmed" placeholder="Confirmed" style={{ width: "300px" }} /><br />
